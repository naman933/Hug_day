...
const GirlCharacter = ({ className = "" }) => (
  <svg viewBox="0 0 200 280" className={className} xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Dress pattern - small hearts */}
    <text x="85" y="180" fontSize="12" fill="#F43F5E" opacity="0.4">&#9829;</text>
    <text x="105" y="195" fontSize="10" fill="#F43F5E" opacity="0.3">&#9829;</text>
    <text x="78" y="208" fontSize="11" fill="#F43F5E" opacity="0.35">&#9829;</text>
    {/* Collar/neckline */}
